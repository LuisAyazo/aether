...
export default function TeamSettingsComponent() {
  console.log('[TeamSettingsComponent] Component mounted');
  ...
  console.log('[TeamSettingsComponent] State:', {
    activeCompany,
  ...
  if (!currentCompany) {
    console.log('[TeamSettingsComponent] No currentCompany, returning null');
    return (
  ...
  console.log('[TeamSettingsComponent] Render conditions:', {
    canManageTeam,
    isPersonalSpace,
    isStarterPlan,
